...
class TestMonitoringCycles:
    ...
    def test_is_in_cooldown_true(self):
        ...
        mock_state = Mock()
        mock_state.updated = datetime.now(timezone.utc) - timedelta(minutes=30)
    ...
    def test_is_in_cooldown_false(self):
        ...
        mock_state = Mock()
        mock_state.updated = datetime.now(timezone.utc) - timedelta(minutes=90)

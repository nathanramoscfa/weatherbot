...
class NHCStormTracker:
    ...
    def _find_storm_page(self, storm: Dict) -> Optional[Dict[str, str]]:
    ...
    def _extract_cone_url(self, page_url: str, html_content: str) -> Optional[str]:
    ...
    def get_storm_cone_geometry(self, storm_page: Dict[str, str]) -> Optional[NHCCone]:
    ...
    def _extract_page_number(self, page_url: str) -> Optional[int]:
    ...
    def _get_mapserver_cone(self, storm_num: int, basin_prefix: str) -> Optional[Polygon]:
